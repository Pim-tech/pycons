...
#m1 = Message(message = 'CONFIRMEZ-MOI CA',textcolor = {'fg': (255,0,255),'bg':( 0,0,0),'mode':5} , motif="\N{DARK SHADE}",confirm='VAS-Y!', confirm_color = {'fg': (255,0,0),'bg': (0,255,0),'mode': 1})
